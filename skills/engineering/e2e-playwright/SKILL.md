...
- **Acceptance criteria (dual-source, in this order):**
  1. **task spec**: the numbered **Acceptance Criteria section** of `docs/tasks/<card>/spec.md`
...
`<ac-source>` is the resolved Step-1 source: `docs/tasks/<card>/spec.md` (task spec) or the legacy
